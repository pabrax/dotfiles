...
apply_kitty() {
	# kitty : theme
	local KITTY_THEME="$PATH_BSPWM/themes/$THEME/kitty/colors.conf"

	# apply default theme colors
	if [[ -f "$KITTY_THEME" ]]; then
		
		# apply colors
		cp -f "$KITTY_THEME" "$PATH_KITTY/colors.conf"
...
apply_vscode() {
	# vscode : theme
	VSCODE_SETTINGS="$PATH_VSCODE/settings.json"
